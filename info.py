...
# Bot information
SESSION = environ.get('SESSION', 'WiseCinema')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1341058877')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002021745680')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001995948776')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nyashs:Yash123147@cluster0.i8yygey.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'WiseCinema')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/WiseCinema')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/WiseCinema')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'NYASHS2727') # Support Chat Link Without https:// or @
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'a3c74cbb41db829e2f840d6c06ed5e394f2bb260')
